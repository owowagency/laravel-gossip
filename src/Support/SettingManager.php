...
namespace OwowAgency\Gossip\Support;

use Illuminate\Support\Arr;
use Illuminate\Support\Collection;
use Illuminate\Support\Str;
use OwowAgency\Gossip\Models\Conversation;
use OwowAgency\Gossip\Models\Contracts\HasSettingsInterface;
...
class SettingManager
{
     ...
     *
     * @param  \OwowAgency\Gossip\Models\Contracts\HasSettingsInterface  $model
     * @return \OwowAgency\Gossip\Support\SettingCollection
     */
    ...
    public static function fillWithSettingsConfig(array $settings): Collection
    {
        ...
        return collect($settings)->map(function (Conversation $setting) use ($configured) {
